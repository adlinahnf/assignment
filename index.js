...
const Visitor = require('./visitor_schema')
const Pass = require('./visitor_pass_schema')
...
const options = {
    definition: {
      ...
      servers:[
        {
            url: 'https://adlina.azurewebsites.net/'
 ...
 mongoose.connect('mongodb+srv://adlinahnf:adlina01@adlina.xobofuv.mongodb.net/t/WJ_VMS')
 .then(()=>{
